  ...
  describe('validateSchema', () => {
    ...
    it('throws if an entity schema is not an object literal', () => {
      nonObjectLiterals.forEach(value => {
        ...
        const error = new Error(
          'schema of entity "chicken" must be an object literal'
        );
        expect(result).toThrow(error);
      });
    });
    ...
    it('throws if a relation schema is not an object literal', () => {
      nonObjectLiterals.forEach(value => {
        ...
        const error = new Error(
          'schema of entity "chicken" relation "ownerId" must be an object literal'
        );
        expect(result).toThrow(error);
      });
    });
    ...
    it('throws if relation schema is missing attribute "entity"', () => {
      ...
      const error = new Error(
        'schema of entity "chicken" relation "ownerId" is missing "entity" attribute'
      );
    ...
    it('throws if relation entity does does not exist in the model schema', () => {
      ...
      const error = new Error(
        'schema of entity "chicken" relation "ownerId" relates to entity "farmer", but entity "farmer" does not have an entity schema of its own'
      );
    ...
    it('throws if relation schema is missing attribute "cardinality"', () => {
      ...
      const error = new Error(
        'schema of entity "chicken" relation "ownerId" is missing "cardinality" attribute'
      );
    ...
    it('throws if cardinality is invalid', () => {
      ...
      const error = new Error(
        'schema of entity "chicken" relation "ownerId" cardinality must be either "one" or "many"'
      );
    ...
    it('throws if relation schema is missing attribute "reciprocal"', () => {
      ...
      const error = new Error(
        'schema of entity "chicken" relation "ownerId" is missing "reciprocal" attribute'
      );
    ...
    it('throws if reciprocal does not point to a relation of the related entity', () => {
      ...
      const error = new Error(
        'schema of entity "chicken" relation "ownerId" has a reciprocal of "foobarIds" on entity "farmer", but "farmer" does not have a relation "foobarIds"'
      );
    ...
    it('throws if reciprocal does not point to a relation that points back', () => {
      ...
      const error = new Error(
        'schema of entity "chicken" relation "ownerId" has a reciprocal of "chickenIds" on entity "farmer", but "chickenIds" does not point back to "ownerId"'
      );
